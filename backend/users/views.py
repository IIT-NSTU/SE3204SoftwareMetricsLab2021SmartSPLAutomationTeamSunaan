...
class VerifyToken(generics.RetrieveAPIView):
...
class UserLoginApiView(ObtainAuthToken):
    ...
    def post(self, request, *args, **kwargs):
        ...
        return Response({'token': token.key, 'username': user.username, 'is_teacher': user.is_teacher,
                         'is_student': user.is_student, 'email': user.email, 'is_verified': user.is_verified,
