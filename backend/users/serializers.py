...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['username', 'email', 'is_teacher', 'is_student', 'is_verified', 'is_superuser', 'is_staff']
...
class TeacherSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['username', 'first_name', 'last_name', 'email', 'designation', 'password', 'confirm_password',
                  'is_teacher',
                  'is_student', 'is_verified', 'token', 'is_superuser', 'is_staff']
...
class StudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['username', 'first_name', 'last_name', 'email', 'roll', 'cgpa', 'password', 'confirm_password',
                  'is_teacher',
                  'is_student', 'token', 'is_verified', 'is_superuser', 'is_staff']
...
class StudentSerializers(serializers.ModelSerializer):
    ...
    def get_user(self, obj):
        res = {'firstname': obj.user_profile.first_name, 'lastname': obj.user_profile.last_name,
               'username': obj.user_profile.username}
        return res
